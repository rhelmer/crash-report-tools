...
// get-explosives.php 0.1
// retrieve explosiveness stats for crash signatures
//
...
$reports = array(array('product'=>'Firefox',
                 ...
                 array('product'=>'Firefox',
                       'version'=>'6',
                       'throttlestart'=>strtotime('2011-08-19'),
                       'fake_adu'=>false,
                       'mincount'=>100,
                      ),
                 array('product'=>'Firefox',
                       'version'=>'5',
                       'throttlestart'=>strtotime('2011-06-23'),
                       'fake_adu'=>false,
                       'mincount'=>50,
                      ),
                 array('product'=>'Firefox',
                       'version'=>'4.0',
                       'throttlestart'=>strtotime('2011-03-29'),
                       'fake_adu'=>false,
                       'mincount'=>50,
                      ),
                 array('product'=>'Firefox',
